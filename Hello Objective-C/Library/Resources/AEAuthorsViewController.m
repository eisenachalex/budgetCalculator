...
@interface AEAuthorsViewController ()

@end

@implementation AEAuthorsViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     */
    AEBooksViewController *booksViewController = [[AEBooksViewController alloc] init];
    NSDictionary *author = [self.authors objectAtIndex:[indexPath row]];
